...
public class DBUtils {
    ...
    public static void signUpUser(ActionEvent event, String username, String password, String name, String surname, String course, String info) {
        ...
        try {
            ...
            if (resultSet.isBeforeFirst()) {
                ...
                psInsert = connection.prepareStatement("INSERT INTO users (username, password, name, surname, course, info) VALUES  (?, ?, ?, ?, ?, ?)");
